...
### Seeding Catalogs
To load the Messier and NGC data:
```bash
cd backend
python -m app.scripts.seed_catalogs
```
...
For information on bulk updates, database cleanup, and catalog seeding, see [UTILITY_SCRIPTS.md](file:///c:/Users/jgood/Github-Code/AstroCat/docs/UTILITY_SCRIPTS.md).
