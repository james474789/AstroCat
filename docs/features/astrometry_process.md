...
The process requires the following environment variable in the `.env` file and `docker-compose.yml`:
- `ASTROMETRY_API_KEY`: Your unique API key from Astrometry.net.
