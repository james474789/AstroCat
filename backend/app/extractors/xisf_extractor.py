...
class XISFExtractor(BaseExtractor):
    ...
    def extract(self) -> Dict[str, Any]:
        ...
        try:
            ...
            metadata["gain"] = float(header_dict.get("GAIN", 0))
            ...
            # Site
            metadata["site_lat"] = fits_ext._parse_coord(header_dict.get("SITELAT"))
            metadata["site_long"] = fits_ext._parse_coord(header_dict.get("SITELONG"))
