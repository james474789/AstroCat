...
| **CR2/NEF/ARW**| rawpy/Pillow | Extracts EXIF data and handles RAW processing. |
| **JPG/TIFF** | Pillow | Extracts standard EXIF metadata. |
...
- `THUMBNAIL_DIR`: Where generated thumbnails are stored.
